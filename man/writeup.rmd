...
---
Disclaimer: as I am not sure about the conduct of publishing actual executable code, pseudo code are used in below for readability. 
...
```
    fit <- randomForest(classe~features, data=train, importance=T)
```
